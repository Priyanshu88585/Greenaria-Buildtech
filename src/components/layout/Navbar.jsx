        ...
        <div className="max-content">
          <div className="flex items-center justify-between h-[72px]">
            ...
            <Link href="/" className="flex items-center gap-3 group flex-shrink-0">
              <div className="w-[48px] h-[48px] rounded-[10px] bg-gradient-to-br from-[#2e7d32] to-[#4caf50] flex items-center justify-center shadow-md group-hover:shadow-[0_4px_20px_rgba(46,125,50,.4)] transition-shadow duration-300">
              ...
              <div className="hidden sm:block">
                <div style={{ fontFamily:"Montserrat,sans-serif", fontWeight:900, fontSize:16, color:"#0d2137", letterSpacing:".06em", lineHeight:1.1 }}>GREENARIA</div>
                <div style={{ fontFamily:"Montserrat,sans-serif", fontWeight:600, fontSize:9,  color:"#2e7d32", letterSpacing:".18em", textTransform:"uppercase" }}>BUILDTECH</div>
              </div>
            </Link>
