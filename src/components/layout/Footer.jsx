      ...
      <div className="max-content">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-14">
          ...
          <div>
            <Link href="/" className="flex items-center gap-3 mb-5">
              <div className="w-11 h-11 rounded-[9px] flex items-center justify-center"
              ...
              <div>
                <div style={{ fontFamily:"Montserrat,sans-serif", fontWeight:900, fontSize:16, color:"#fff", letterSpacing:".06em", lineHeight:1.1 }}>GREENARIA</div>
                <div style={{ fontFamily:"Montserrat,sans-serif", fontWeight:600, fontSize:9, color:"#4caf50", letterSpacing:".18em", textTransform:"uppercase" }}>BUILDTECH</div>
              </div>
            </Link>

            <p style={{ fontSize: 13.5, color: "#8a98ae", lineHeight: 1.7, marginBottom: 20 }}>
              Your trusted partner for all real estate needs in Gurgaon. Professional, reliable, and result-oriented services.
            </p>

            {[
              { icon: "🏢", text: "A-512-517, 5th floor, Tower A, Emaar Digital Greens, Golf Course Ext Rd, Sector 61, Gurugram 122102" },
              { icon: "📞", text: "+91 7400230074" },
        ...
        <div className="py-5 flex flex-wrap items-center justify-between gap-3"
          ...
          <p style={{ fontSize: 13, color: "#5a6580" }}>
            © {new Date().getFullYear()} Greenaria BuildTech. All rights reserved.
          </p>
