      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#2e7d32] to-[#4caf50] flex items-center justify-center">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="1.8"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9,22 9,12 15,12 15,22"/></svg>
            </div>
            <div>
              <div style={{ fontFamily:"Montserrat", fontWeight:900, fontSize:13, color:"#0d2137" }}>GREENARIA</div>
              <div style={{ fontFamily:"Montserrat", fontWeight:600, fontSize:8,  color:"#2e7d32", letterSpacing:".16em" }}>BUILDTECH</div>
            </div>
          </div>
