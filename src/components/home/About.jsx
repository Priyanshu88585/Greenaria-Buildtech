    ...
    <section id="about" className="section-pad" style={{ background:"#fff" }}>
      <div className="max-content">
        ...
        <div className="max-w-[900px] mx-auto space-y-5">
          {[
            <><strong>Greenaria BuildTech</strong> is a trusted and experienced <span style={{color:"#2e7d32",fontWeight:600}}>real estate developer in Gurgaon</span>, associated with some of the most reputed builders in the industry, including <strong>DLF, M3M, Trump Towers, AIPL, Bhutani Group, Emaar, and Sobha Dubai</strong>. With over <strong>10 years of experience</strong> and <strong>8,000+ successful property transactions</strong>, we have established ourselves as a leading real estate consultancy catering to both Indian and international markets.</>,
            <>We offer premium residential, commercial, and investment property advisory services across <strong>Gurgaon, Delhi-NCR, Noida, and Dubai</strong>. Recognised with multiple awards from top developers, Greenaria BuildTech is known for its strong market knowledge, ethical practices, and excellence in marketing new real estate developments. Our reputation as one of the <span style={{color:"#2e7d32",fontWeight:600}}>best real estate consultants in Gurgaon</span> is built on long-term client trust and consistent results.</>,
